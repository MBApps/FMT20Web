...
with st.sidebar:
    model = st.selectbox('', (FMT20.OptimalMergerPolicy, FMT20.ProCompetitive, FMT20.ResourceWaste), format_func=model_label, key='model')
    ...
    configs = st.selectbox('Available configurations',get_configurations(), format_func=configuration_label, on_change=set_config, key='configs')
